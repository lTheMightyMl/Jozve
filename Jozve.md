...
`image`
In an unconstrained optimization problem, every point $x \in \mathbb{R}^n$ is feasible, so singular focus is on minimizing #(!)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3MjE4Nzg0MSwxNTMxOTkxMTM4LC0xMD
